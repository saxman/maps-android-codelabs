...
/**
 * A selection dialog for the map type. It provides four choices: Normal,
 * Hybrid, Satellite, Terrain. The attaching Activity must implement the
 * MapTypeDialogListener interface to receive a callback on selection.
 */
public class SelectMapTypeDialog extends DialogFragment {
    ...
    /**
     * Interface used by callbacks from the SelectMapTypeDialog when the user
     * makes a selection.
     */
