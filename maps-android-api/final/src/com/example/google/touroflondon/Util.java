...
public class Util {
    ...
    /**
     * Preference key used to indicate whether data has been loaded into the
     * database.
     */
    ...
    /**
     * Mark the data as loaded. This flag should be set to true once the
     * route.json file has been parsed and stored in the database.
     * 
     * @param context
