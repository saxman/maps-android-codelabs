 ...
 * {@link #loadInBackground()} to return the Cursor for the Loader.
 *
 * (Based on the CursorLoader implementation from the Android framework, but this implementation also supports
 * generic Cursors from an SQL query.
 */
